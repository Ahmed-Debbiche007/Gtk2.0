...
void
on_button_3_clicked                    (GtkButton       *objet,
                                        gpointer         user_data)
{
...
void
on_button_4_clicked                    (GtkButton       *objet,
                                        gpointer         user_data)
{
GtkWidget *treeview1, *treeview2, *af_alarme, *dashboard_hebergement;
...
treeview1=lookup_widget(af_alarme,"treeview_fumee");

detection_fumee(treeview1);

treeview2=lookup_widget(af_alarme,"treeview_mvt");
...
void
on_button_2_clicked                    (GtkButton       *objet,
                                        gpointer         user_data)
{
...
void
on_button_1_clicked                    (GtkButton       *objet,
                                        gpointer         user_data)
{
...
void
on_button_mvt_clicked                  (GtkButton       *objet,
                                        gpointer         user_data)
{
GtkWidget *treeview3;
treeview3=lookup_widget(objet,"treeview_mvt");
detection_fumee(treeview3);
}


void
on_button_af_alarme_clicked            (GtkButton       *objet,
                                        gpointer         user_data)
{
GtkWidget *treeview;
treeview=lookup_widget(objet,"treeview_fumee");
detection_mouvement(treeview);
}


void
on_button_af_clicked                   (GtkButton       *objet,
                                        gpointer         user_data)
{
...
void
on_ajouterd_clicked                    (GtkButton       *objet,
                                        gpointer         user_data)
{
GtkWidget *w1 , *w2;
w1=lookup_widget(objet,"af_hebergement");
w2=lookup_widget(objet,"aj_hebergement");
gtk_widget_hide(w1);
gtk_widget_show(w2);
...
void
on_button501_clicked                   (GtkButton       *objet,
                                        gpointer         user_data)
{
GtkWidget *w1 , *w2;
w1=lookup_widget(objet,"af_hebergement");
w2=lookup_widget(objet,"mod_hebergement");
gtk_widget_hide(w1);
gtk_widget_show(w2);
