...
void
on_button7_chercheryosra_clicked       (GtkButton       *button,
                                        gpointer         user_data);

void
on_button8_chercher_clicked            (GtkButton       *button,
                                        gpointer         user_data);
...
void
on_button37_activate                   (GtkButton       *button,
                                        gpointer         user_data);
...
void
on_checkbutton6_clicked                (GtkButton       *button,
                                        gpointer         user_data);
...
void
on_ydash_clicked                       (GtkButton       *button,
                                        gpointer         user_data);
